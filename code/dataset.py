...
class HeadPositionDataset(Dataset):
    ...
    def __init__(self, csv_file, root_dir, transform=None):
        ...
        """
        self.head_data = pd.read_csv('../dsp_intent_analyzer_dataset/head_data.csv')
    ...
    def __getitem__(self, idx):
        ...
        img_name = os.path.join(self.root_dir, self.head_data.iloc[idx, file_idx])
        image = io.imread(img_name)

        # This is not converted into float yet
