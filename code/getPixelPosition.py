...
class Zoom_Advanced(ttk.Frame):
    ...
    def __init__(self, mainframe, path):
        ...
        self.canvas.bind("<Double-Button-1>", self.printcoords) # mouseclick event
    ...
    #function to be called when mouse is double-clicked
