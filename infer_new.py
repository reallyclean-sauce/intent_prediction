...
from attentionfollow.code.gazenet import GazeNet
...
from attentionfollow.code.utils import data_transforms
from attentionfollow.code.utils import get_paste_kernel, kernel_map
